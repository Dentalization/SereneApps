...
router.put('/profile', authenticateToken, requireRoles(['owner', 'manager']), upload.fields([
  { name: 'ktpFile', maxCount: 1 },
  { name: 'ktpSelfie', maxCount: 1 },
  { name: 'nibFile', maxCount: 1 },
  { name: 'npwpFile', maxCount: 1 },
...
router.post('/branches', authenticateToken, requireRoles(['owner', 'manager']), async (req, res) => {
  try {
...
router.get('/branches', authenticateToken, requireRoles(['owner', 'manager']), async (req, res) => {
  try {
    const clinicProfile = await prisma.clinicProfile.findFirst({
      where: { userId: req.user.id }
    });
...
router.put('/branches/:id', authenticateToken, requireRoles(['owner', 'manager']), async (req, res) => {
  try {
    const { id } = req.params;
...
router.delete('/branches/:id', authenticateToken, requireRoles(['owner', 'manager']), async (req, res) => {
  try {
    const { id } = req.params;
...
router.get('/staff', authenticateToken, requireRoles(['owner', 'manager']), async (req, res) => {
  try {
    const user = req.user;
...
router.post('/staff', authenticateToken, requireRoles(['owner', 'manager']), async (req, res) => {
  try {
...
router.put('/staff/:staffId', authenticateToken, requireRoles(['owner', 'manager']), async (req, res) => {
  try {
...
router.get('/staff/:userId/profile', authenticateToken, requireRoles(['owner', 'manager']), async (req, res) => {
  try {
...
router.put('/staff/:userId/role', authenticateToken, requireRoles(['owner', 'manager']), async (req, res) => {
  try {
    const { userId } = req.params;
...
router.delete('/staff/:userId', authenticateToken, requireRoles(['owner', 'manager']), async (req, res) => {
  try {
    const { userId } = req.params;
    const user = req.user;
