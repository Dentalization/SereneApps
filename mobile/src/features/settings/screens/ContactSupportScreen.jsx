  ...
  return (
    <InfoScreenLayout
      heroProps={{
        ...
        subtitle: 'Tim Care Concierge siap membantu kebutuhan klinis dan teknis Anda kapan saja.',
    ...
    >
      <SettingsSection title="KONTAK LANGSUNG" description="Pilih kanal komunikasi favorit Anda.">
        <List.Item
          title="Email Care"
      ...
      <SettingsSection title="KIRIM PESAN CEPAT" description="Kami balas melalui email dalam hitungan menit.">
      ...
      <SettingsSection title="WAKTU RESPON" description="Ikuti status tiket Anda.">
        <View style={styles.timelineRow}>
          <Text style={[styles.timelineLabel, { color: theme.colors.onSurfaceVariant }]}>Prioritas</Text>
          <Text style={styles.timelineValue}>Klinis mendesak</Text>
          <Text style={styles.timelineEta}>⏱ 2 menit</Text>
        </View>
        <View style={styles.timelineRow}>
          <Text style={[styles.timelineLabel, { color: theme.colors.onSurfaceVariant }]}>Standar</Text>
          <Text style={styles.timelineValue}>Janji & billing</Text>
          <Text style={styles.timelineEta}>⏱ 5 menit</Text>
        </View>
        <View style={styles.timelineRow}>
          <Text style={[styles.timelineLabel, { color: theme.colors.onSurfaceVariant }]}>Non-urgent</Text>
