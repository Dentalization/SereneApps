      ...
      <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
        <div className="relative w-full max-w-2xl max-h-[85vh] bg-surface-elevated rounded-2xl shadow-2xl overflow-y-auto">
          ...
          <div className="flex items-center justify-between p-6 border-b border-border/40">
            <div>
              <h2 className="text-xl font-semibold text-primary">Edit Branch</h2>
              <p className="text-sm text-secondary mt-1">Update branch information and settings</p>
            </div>
            <button
              type="button"
              onClick={onClose}
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <input
                    ...
                    disabled={branch.isMainBranch} // Don't allow unsetting main branch
                    className="w-4 h-4 text-accent border-border/40 rounded focus:ring-accent focus:ring-2 disabled:opacity-50"
                  />
                  <label htmlFor="isMainBranch" className="text-sm text-primary">
                    Set as main branch
                    {branch.isMainBranch && (
                      <span className="text-xs text-secondary ml-2">(Current main branch)</span>
                    )}
                  </label>
                </div>
