            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div className="space-y-2">
                <p className="text-xs font-semibold uppercase tracking-wide text-accent">
                  {t('admin.partnerships.badge') || 'Partnerships'}
                </p>
                <h1 className="text-2xl font-bold text-primary">
                  {t('admin.nav.partnerships') || 'Kemitraan'}
                </h1>
                <p className="text-sm text-secondary max-w-2xl">
                  {t('admin.partnerships.subtitle') || 'Direktori partner, manajemen API, dan pengawasan integrasi'}
                </p>
              </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 md:px-8 pt-4 pb-6 md:pb-8 bg-background theme-transition">
          ...
          <div className="bg-surface border border-border/40 rounded-2xl p-12 text-center">
            <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30 flex items-center justify-center">
              <AppIcon name="Handshake" size={40} className="text-indigo-600 dark:text-indigo-400" />
            </div>
            <h2 className="text-2xl font-bold text-primary mb-4">Partnerships</h2>
            <p className="text-muted-foreground max-w-md mx-auto mb-8">
              Strategic partnership management with API integration tools and partner directory administration.
            </p>
          </div>
        </div>
      </div>
