      ...
      {exports.length > 0 && (
        <div className="mt-4 space-y-2">
          {exports.map((entry) => {
            ...
            return (
              <div key={entry.id} className={`rounded-xl border p-3 ${isDraft ? 'border-red-300 bg-red-50 dark:border-red-900 dark:bg-red-950/30' : 'border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-900'}`}>
