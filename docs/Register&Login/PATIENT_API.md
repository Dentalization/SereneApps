...
**3 Endpoints:**
1. **GET /v1/patient/profile** - Get patient profile data
2. **PUT /v1/patient/profile** - Update patient profile data
3. **POST /v1/patient/avatar** - Upload patient avatar/profile picture
...
1. [Overview](#overview)
2. [Endpoint GET /v1/patient/profile](#endpoint-get-v1patientprofile)
3. [Endpoint PUT /v1/patient/profile](#endpoint-put-v1patientprofile)
4. [Endpoint POST /v1/patient/avatar](#endpoint-post-v1patientavatar)
...
Retrieve the authenticated patient's profile information.
...
- This endpoint is called **automatically after login** by the mobile app to populate Redux state
- If patient profile doesn't exist (404), mobile app will gracefully handle it
- User can create their profile by editing it in EditProfileScreen (which triggers PUT endpoint)
...
### 1. Get Profile Endpoint (GET /v1/patient/profile)
...
### 2. Update Profile Endpoint (PUT /v1/patient/profile)
...
### 3. Upload Avatar Endpoint (POST /v1/patient/avatar)
...
#### 2. Get Profile (should return 404 initially)
```bash
...
Expected response: 404 (profile not created yet)

#### 3. Update Profile (creates profile on first call)
```bash
TOKEN="your_access_token_here"
...
#### 4. Get Profile Again (should return 200 with data)
```bash
TOKEN="your_access_token_here"
...
- [ ] Add `getPatientProfile` function
...
- [ ] Test GET /v1/patient/profile with cURL
...
- [✅] `getPatientProfile()` function implemented
- [✅] `updatePatientProfile()` function implemented
- [✅] `uploadPatientAvatar()` function implemented
- [✅] LoginScreen.jsx updated to fetch patient profile after login
